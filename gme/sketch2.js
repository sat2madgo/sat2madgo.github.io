...
function cavasReady() {
  ...
  featurez = fx.infer(getpart(canv.canvas));
  var intv=setInterval(tryAct,1200);
}
...
function getpart(cnv){
var cxv = document.getElementById("trimmer");


cxv.getContext('2d').drawImage(cnv, 0, 0);
return cxv;
